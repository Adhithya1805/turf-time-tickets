  ...
  return <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <Link to="/browse" className="text-sm font-medium text-foreground transition-colors hover:text-primary">
            Browse Turfs
          </Link>
          <Link to="/how-it-works" className="text-sm font-medium text-foreground transition-colors hover:text-primary">
            How It Works
          </Link>
          <Link to="/bookings" className="text-sm font-medium text-foreground transition-colors hover:text-primary">
            My Bookings
          </Link>
        </nav>
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side="right">
              <nav className="flex flex-col gap-4 mt-8">
                ...
                <Link to="/browse" className="text-lg font-medium" onClick={() => setIsOpen(false)}>
                  Browse Turfs
                </Link>
                <Link to="/how-it-works" className="text-lg font-medium" onClick={() => setIsOpen(false)}>
                  How It Works
                </Link>
                <Link to="/bookings" className="text-lg font-medium" onClick={() => setIsOpen(false)}>
                  My Bookings
                </Link>
